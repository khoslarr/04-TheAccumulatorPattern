...
#
#              for k in range(r - s): --- Doesn't include s
#                  count = 0 --- Should be outside the for loop
#                  if math.cos(r) > 0: --- will only cosine of r, instead of increasing with k
#                      count = 1 --- count will just be 1 instead of increasing. Should be count + 1
#                  return count --- return statement is in the for loop. Can't finish the whole loop
#
